                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>RUC</label>
                                        <input minlength="11" maxlength="11" type="text" class="form-control" placeholder="Ingrese RUC" name="cliente_ruc" onkeypress="return isNumber(event);" minlength="11" maxlength="11" required>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label>Razón Social</label>
                                        <input type="text" class="form-control" placeholder="Ingrese razón social" name="cliente_razsoc" onkeypress="return validar_nomlargo(event);" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Nombre Comercial</label>
                                        <input type="text" class="form-control" placeholder="Ingrese nombre comercial" name="cliente_nomcom" onkeypress="return validar_nomlargo(event);">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" pattern="[0-9--]{0,20}" placeholder="Ingrese teléfono fijo" name="cliente_telfij" onkeypress="return isNumber(event);" minlength="7" maxlength="7">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" pattern="[0-9--]{0,20}" placeholder="Ingrese teléfono celular" name="cliente_telcel" onkeypress="return isNumber(event);" minlength="9" maxlength="9">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input type="text" class="form-control" placeholder="Ingrese nombre de contacto" name="cliente_nomcont_1" onkeypress="return solo_texto(event);">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="phone" class="form-control" name="cliente_celcont_1" pattern="[0-9--]{0,20}" onkeypress="return isNumber(event);" minlength="9" maxlength="9">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input type="text" class="form-control" placeholder="Ingrese nombre de contacto" name="cliente_nomcont_2" onkeypress="return solo_texto(event);">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="phone" class="form-control" name="cliente_celcont_2" pattern="[0-9--]{0,20}" onkeypress="return isNumber(event);" minlength="9" maxlength="9">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
