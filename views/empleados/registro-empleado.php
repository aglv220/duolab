                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nombres</label>
                                        <input type="text" class="form-control" placeholder="Ingrese nombres" name="empleado_nombres" onkeypress="return solo_texto(event);" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Apellido Paterno</label>
                                        <input type="text" class="form-control" placeholder="Ingrese apellido paterno" name="empleado_apepat" onkeypress="return solo_texto(event);" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Apellido Materno</label>
                                        <input type="text" class="form-control" placeholder="Ingrese apellido materno" name="empleado_apemat" onkeypress="return solo_texto(event);" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese número de Doc." name="empleado_numdoc" onkeypress="return isNumber(event);" required>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="phone" class="form-control" pattern="[0-9--]{0,20}" placeholder="Ingrese teléfono" name="empleado_telefono" onkeypress="return isNumber(event);" maxlength="9">
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label>Carrera</label>
                                        <input type="text" class="form-control" placeholder="Ingrese carrera" name="empleado_carrera" onkeypress="return solo_texto(event);">
                                    </div>
                                </div>
                            </div>
                        </div>
