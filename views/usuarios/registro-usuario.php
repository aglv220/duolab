                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Ingrese nombre de usuario" name="usuario_nombre" pattern="[A-Za-z0-9_-]{1,50}" maxlength="50" onkeypress="return validar_nomcorto(event);" autocomplete="username" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="password" id="usuario_pass" class="form-control" placeholder="Ingrese contraseña" name="usuario_pass" pattern="[A-Za-z0-9_-]{1,72}" maxlength="72" autocomplete="new-password" onkeypress="return noWhitesSpace(event);" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="password" id="usuario_pass_conf" class="form-control" placeholder="Confirme contraseña" name="usuario_pass_conf" pattern="[A-Za-z0-9_-]{1,72}" maxlength="72" autocomplete="new-password" onkeypress="return noWhitesSpace(event);" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
